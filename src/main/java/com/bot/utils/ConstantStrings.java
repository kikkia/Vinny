...
public class ConstantStrings {
    ...
    public static String WELCOME_MESSAGE = "Hey all! Thanks for adding me to your server! To get started you can go to https://github.com/JessWalters/Vinny-Redux/blob/master/docs/Commands.md" +
